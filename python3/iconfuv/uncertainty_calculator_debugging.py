# Ulas Kamaci - 2022-03-23
# uncertainty_calculation v2.0_debugging
# this version is meant to find out what is causing the discrepancy between
# Harald's version and the SDC version of this code. Extra outputs are obtained.
...
def uncertainty_calculator(
    ...
    if index_night is not None:
        ...
        if calculated_background is True:
            return uncertainty_profile, gain_day, gain_night, background_mean, background_std, profile_flatfield, profile_ff, signal, signal_variance
        else:
